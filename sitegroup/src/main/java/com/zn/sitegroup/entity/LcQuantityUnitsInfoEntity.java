 ...
 */
@Entity
@Table(name = "lc_quantity_units_info", schema = "litecart", catalog = "")
public class LcQuantityUnitsInfoEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        LcQuantityUnitsInfoEntity that = (LcQuantityUnitsInfoEntity) o;
