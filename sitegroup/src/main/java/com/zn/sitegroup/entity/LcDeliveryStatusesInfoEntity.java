 ...
 */
@Entity
@Table(name = "lc_delivery_statuses_info", schema = "litecart", catalog = "")
public class LcDeliveryStatusesInfoEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        LcDeliveryStatusesInfoEntity that = (LcDeliveryStatusesInfoEntity) o;
